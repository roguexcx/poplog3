...
export default function HiatusReturnBanner({ event, onSelect }: Props) {
    ...
    return (<button type="button" onClick={() => onSelect?.(event)} className="rounded-lg border border-cyan-300/20 bg-cyan-950/25 p-4 text-left transition hover:border-cyan-200/45">
      <p className="text-xs font-semibold uppercase tracking-[0.2em] text-cyan-200">{uiMessage("ui.32ea611419a9")}</p>
