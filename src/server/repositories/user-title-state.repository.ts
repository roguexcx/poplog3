...
function statePatch(input: UpsertUserTitleStateInput) {
  return {
    ...
    bestProviderName: input.bestProviderName ?? null,
    bestProviderType: input.bestProviderType ?? null,
    bestProviderLogo: input.bestProviderLogo ?? null,
    durationSortMinutes: input.durationSortMinutes ?? null,
    durationSortUnavailable: input.durationSortUnavailable ?? false,
    editorialAffinity: input.editorialAffinity ?? 0,
    editorialPenalty: input.editorialPenalty ?? 0,
    editorialScore: input.editorialScore ?? 0,
    hasNegativeFeedback: input.hasNegativeFeedback ?? false,
    isHidden: input.isHidden ?? false,
    isBoosted: input.isBoosted ?? false,
    lastFeedbackType: input.lastFeedbackType ?? null,
    lastFeedbackAt: toDate(input.lastFeedbackAt),
