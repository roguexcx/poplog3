...
export const GENRE_TRANSLATION_BY_NAME: Record<string, string> = {
  ...
  Soap: "Novela", Thriller: "Suspense", War: "Guerra", Western: "Faroeste",
  Kids: "Infantil", News: "Notícias", Reality: "Reality", Talk: "Talk show",
  "War & Politics": "Guerra e política",
};

export const MEDIA_TYPE_LABEL: Record<MediaType, string> = { movie: "Filme", tv: "Série" };
...
export function formatRuntimeLabel(minutes?: number | null): string | null {
...
export function parseYearLabel(releaseDate?: string | null, firstAirDate?: string | null): string | null {
