...
const STATUS_CONFIG: Record<string, {
    ...
    watched: { label: uiMessage("ui.ab53b20a28e7"), cls: "border-emerald-500/40 bg-emerald-900/75 text-emerald-300" },
...
export default function LibraryStateBadge({ className, ...identity }: Props) {
    ...
    const label = isFavorite && status === "watched" ? `★ ${cfg.label}` : cfg.label;
