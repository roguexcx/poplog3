      ...
      {total > 1 && (
        <>
          <button
            ...
            className="absolute left-4 top-1/2 z-30 -translate-y-1/2 rounded-full border border-white/10 bg-black/40 p-3 text-white/50 backdrop-blur-md opacity-0 group-hover:opacity-100 hover:bg-black/60 hover:text-white transition-all duration-300"
          ...
          <button
            ...
            className="absolute right-4 top-1/2 z-30 -translate-y-1/2 rounded-full border border-white/10 bg-black/40 p-3 text-white/50 backdrop-blur-md opacity-0 group-hover:opacity-100 hover:bg-black/60 hover:text-white transition-all duration-300"
