...
### Aviso de Isencao de Responsabilidade
...
Cookies essenciais e armazenamento local podem ser usados para manter sessao, seguranca, idioma, regiao, consentimentos e funcionamento basico do produto. Cookies nao essenciais, publicidade personalizada, analytics ou tecnologias equivalentes devem depender de configuracao especifica, informacao clara ao usuario e consentimento quando exigido.
...
### Remocao ou Correcao de Metadados
...
### Metadata Removal or Correction
